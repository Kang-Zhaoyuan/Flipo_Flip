...
SUPPORTED_FLIPO_COLORS = ("pink", "dark_red", "dark_green", "white")
...
def prompt_flipo_color(video_path: str) -> str:
    ...
    while True:
        raw = input("Enter color choice [1-4]: ").strip().lower()
        if raw in alias_map:
            return alias_map[raw]
        print("Invalid color. Please choose one of: pink, dark_red, dark_green, white.")
