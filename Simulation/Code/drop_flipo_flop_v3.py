...
print(f"Raw X dimension: {raw_h:.4f} m, Scale factor: {scale_factor:.6f}")
print(f"Target physical width: {target_width:.4f} m")
print(f"Initial drop height: {target_height:.4f} m")
print(f"-----------------------------\n")

# 5. Build the Final XML with Damping and Shadow Fixes
final_xml = f"""
<mujoco>
